...
export const myProjects = [
  ...
  {
    title: 'Incident Triage AI Benchmark ',
    desc: 'Built an AI-powered incident triage benchmark system that simulates real-world software incidents and evaluates autonomous agent decision-making.',
    subdesc: 'Developed an AI agent that analyzes incident tickets, retrieves runbooks, assigns severity/ownership, and drafts resolution responses. Built an automated benchmarking pipeline with OpenAI SDK, Pydantic, Docker, and structured evaluation metrics for reliable agent performance testing.',

    href: 'https://github.com/gargDhruv12/openenv-ops-triage',
...

  {
    ...
    desc: 'Built a machine learning–based software defect prediction system that identifies defect-prone Java source files using AI-generated postmortem and code analysis data.',
    subdesc: 'Developed an end-to-end ML pipeline using Scikit-learn, TF-IDF NLP, and Genetic Algorithms to classify defect-prone modules and improve prediction accuracy. Benchmarked multiple classifiers, reduced manual review effort through targeted file flagging, and ranked among top teams in the ISEC Data Challenge.',
...
export const workExperiences = [
  {
    id: 1,
    name: 'Research Intern - NIT Kurukshetra',
    pos: 'Research Intern',
    duration: 'Jan 2026- May 2026',
    title: "Conducted deep analysis of Android ContactsProvider (contacts2.db), mapping 100+ fields, MIME types, and relational schema to understand data storage and lifecycle. \n" + "Implemented SQL-based data insertion and extraction, leveraging unused MIME-type fields to store custom data without modifying core schema or system constraints.",
  ...
  },
  {
    ...
    duration: 'June 2025- July',
    title: " Completed a 3-week training on Ethical Hacking and Penetration Testing. Worked on a 3-week project: “Traffic Monitoring Use Cases using Network Monitoring Tools”",
